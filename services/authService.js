...
const api = {
  registrarUsuario: (data)  => apiRequest("/auth/registro", { method: "POST", body: data }),
  iniciarSesion:    (data)  => apiRequest("/auth/login",    { method: "POST", body: data }),
  cerrarSesion:     (token) => apiRequest("/auth/logout",   { method: "POST" }, token),
};
